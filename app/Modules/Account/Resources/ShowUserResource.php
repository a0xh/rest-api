...
use App\Entities\{Media, Permission};
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'role' => $this->getRole() ? [
                ...
                'permission' => $this->getRole()->getPermissions()->isEmpty() ? null : array_map(
                    callback: function (Permission $permission): array {
                        return [
                            ...
                            'datetime' => [
                                'created_at' => $permission->getCreatedAt()->format(
                                    format: 'Y-m-d H:i:s'
                                ),
                                'updated_at' => $permission->getUpdatedAt()->format(
                                    format: 'Y-m-d H:i:s'
                                ),
                            ],
                        ];
                    },
                    array: $this->getRole()->getPermissions()->toArray()
                )
            ] : null,
            'datetime' => [
